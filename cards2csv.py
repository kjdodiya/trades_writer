...
if __name__ == "__main__":
    ...
    parser.add_argument('-b','--board', default='gpm-trades-2020', help='Board ID of the board to generate CSV for')
    parser.add_argument('-cf','--conf_file', help='Config file containing configuration')
